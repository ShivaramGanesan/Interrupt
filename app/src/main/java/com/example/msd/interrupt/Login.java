package com.example.msd.interrupt;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toRegistration = (TextView)findViewById(R.id.toSignUp);
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(TextUtils.isEmpty(emailEditText.getText().toString()) || TextUtils.isEmpty(passwordEditText.getText().toString())){
                    Toast.makeText(Login.this, "insufficient credentials!", Toast.LENGTH_SHORT).show();
                    return;
                }
